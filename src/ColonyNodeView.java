...
public class ColonyNodeView extends JPanel
{
	...
	private final Color OPEN_NODE_COLOR = new Color(245, 166, 185);
	
	// background color if queen is present
	private final Color QUEEN_NODE_COLOR = new Color(227, 171, 235);
	...
	private final Color PHEROMONE_1000 = new Color(237, 17, 123);	// make it pink
	private final Color PHEROMONE_800 = new Color(245, 100, 197);	// orange
	private final Color PHEROMONE_600 = new Color(237, 126, 235);	// yellow
	private final Color PHEROMONE_400 = new Color(235, 110, 139);	// green
	private final Color PHEROMONE_200 = new Color(240, 129, 155);		// blue
	private final Color PHEROMONE_0 = new Color(245, 149, 172);		// violet
