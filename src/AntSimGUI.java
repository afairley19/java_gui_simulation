...
public class AntSimGUI extends JFrame
{
	...
	public void initGUI(ColonyView colonyView)
	{
		...
		colonyPane.setPreferredSize(new Dimension(500, 300));
	...
	//	private JButton soldierTestButton;
		...
		{
			// setup button
			normalSetupButton = new JButton("Build the Colony!");
		...
		/*	// queen test button
			...
			runButton = new JButton("Continuous Run");
			...
			stepButton = new JButton("Step Run");
			...
			timeLabel.setFont(new Font("Helvetica", Font.BOLD, 12));
		}	
		...
		private class ButtonHandler implements ActionListener
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (b.getText().equals("Build the Colony!"))
				{
...
//					fireSimulationEvent(SimulationEvent.SOLDIER_TEST_EVENT);
				//}
				else if (b.getText().equals("Continuous Run"))
				{
					// run the simulation continuously
					fireSimulationEvent(SimulationEvent.RUN_EVENT);
				}
				else if (b.getText().equals("Step Run"))
				{
